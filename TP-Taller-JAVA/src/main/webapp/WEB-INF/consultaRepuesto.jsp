...
<body>
	...
	<div>
		<form action="Conexion" method="post">
			...
			<button class="btn btn-primary" type="submit" name="optionBM" value="repuestos">Volver</button>
		</form>
	</div>
		...
		<div class="dentro d-flex flex-column  justify-content-center align-items-center">
			...
			<div class="row text-center">
				<div class="col text center">
					<label  class="font-weight-bold">ID del repuesto</label>
					<input class="form-control text-center bg-light" type="number" value="<%=r.getId_repuesto() %>" disabled>
				</div>
			</div>
			<!-- Descripcion -->
			<div class="row text-center">
				<div class="col text center">
					...
					<input class="form-control text-center bg-light" type="text" value="<%=r.getDescripcion() %>" disabled>
				</div>
			</div>
			<!-- Precio -->
			<div class="row text-center">
				<div class="col text center">
					...
					<input class="form-control text-center bg-light" type="number" value="<%=r.getPrecio() %>" disabled>
				</div>
			</div>
			<!-- Stock -->
			<div class="row text-center">
				<div class="col text center">
					...
					<input class="form-control text-center bg-light" type="number" value="<%=r.getStock() %>" disabled>
				</div>
			</div>
